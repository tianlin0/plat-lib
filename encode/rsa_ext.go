...
var (
	ErrDataToLarge     = fmt.Errorf("message too long for RSA public key size")
	...
	ErrDecryption      = fmt.Errorf("decryption error")
	ErrPublicKey       = fmt.Errorf("get public key error")
	ErrPrivateKey      = fmt.Errorf("get private key error")
)
...
func getPriKey(privatekey []byte) (*rsa.PrivateKey, error) {
	...
	if block == nil {
		return nil, fmt.Errorf("get private key error")
	}
