...
type (
	// ValueSetter is the interface which can be accepted as a generic solution of RequestParams or
	// memStore when Set is the only requirement,
	// ie internally on macro/template/TemplateParam#Eval:paramChanger.
	ValueSetter interface {
		Set(key string, newValue interface{}) (MemEntry, bool)
	}
	// MemEntry is the entry of the context storage Store - .Values()
	MemEntry struct {
		Key       string
		ValueRaw  interface{}
...
func (e MemEntry) GetByKindOrNil(k reflect.Kind) interface{} {
	switch k {
	case reflect.String:
...
func (e MemEntry) StringDefault(def string) string {
	v := e.ValueRaw
	if v == nil {
		return def
	}
...
func (e MemEntry) String() string {
	return e.StringDefault("")
}

// StringTrim returns the entry's string value without trailing spaces.
func (e MemEntry) StringTrim() string {
	return strings.TrimSpace(e.String())
}

func formatError(a ...interface{}) error {
	errStr := fmt.Sprintf("unable to find the %s with key: %s", a...)
	return fmt.Errorf(errStr)
}

// IntDefault returns the entry's value as int.
// If not found returns "def" and a non-nil error.
func (e MemEntry) IntDefault(def int) (int, error) {
	v := e.ValueRaw
	if v == nil {
		return def, formatError("int", e.Key)
	}
...
// If not found returns "def" and a non-nil error.
func (e MemEntry) Int8Default(def int8) (int8, error) {
	v := e.ValueRaw
	if v == nil {
		return def, formatError("int8", e.Key)
	}
...
// If not found returns "def" and a non-nil error.
func (e MemEntry) Int16Default(def int16) (int16, error) {
	v := e.ValueRaw
	if v == nil {
		return def, formatError("int16", e.Key)
	}
...
// If not found returns "def" and a non-nil error.
func (e MemEntry) Int32Default(def int32) (int32, error) {
	v := e.ValueRaw
	if v == nil {
		return def, formatError("int32", e.Key)
	}
...
// If not found returns "def" and a non-nil error.
func (e MemEntry) Int64Default(def int64) (int64, error) {
	v := e.ValueRaw
	if v == nil {
		return def, formatError("int64", e.Key)
	}
...
// If not found returns "def" and a non-nil error.
func (e MemEntry) UintDefault(def uint) (uint, error) {
	v := e.ValueRaw
	if v == nil {
		return def, formatError("uint", e.Key)
	}
...
// If not found returns "def" and a non-nil error.
func (e MemEntry) Uint8Default(def uint8) (uint8, error) {
	v := e.ValueRaw
	if v == nil {
		return def, formatError("uint8", e.Key)
	}
...
// If not found returns "def" and a non-nil error.
func (e MemEntry) Uint16Default(def uint16) (uint16, error) {
	v := e.ValueRaw
	if v == nil {
		return def, formatError("uint16", e.Key)
	}
...
// If not found returns "def" and a non-nil error.
func (e MemEntry) Uint32Default(def uint32) (uint32, error) {
	v := e.ValueRaw
	if v == nil {
		return def, formatError("uint32", e.Key)
	}
...
// If not found returns "def" and a non-nil error.
func (e MemEntry) Uint64Default(def uint64) (uint64, error) {
	v := e.ValueRaw
	if v == nil {
		return def, formatError("uint64", e.Key)
	}
...
// If not found returns "def" and a non-nil error.
func (e MemEntry) Float32Default(_ string, def float32) (float32, error) {
	v := e.ValueRaw
	if v == nil {
		return def, formatError("float32", e.Key)
	}
...
// If not found returns "def" and a non-nil error.
func (e MemEntry) Float64Default(def float64) (float64, error) {
	v := e.ValueRaw
	if v == nil {
		return def, formatError("float64", e.Key)
	}
...
//
// If not found returns "def" and a non-nil error.
func (e MemEntry) BoolDefault(def bool) (bool, error) {
	v := e.ValueRaw
	if v == nil {
		return def, formatError("bool", e.Key)
	}
...
func (e MemEntry) Value() interface{} {
	if e.immutable {
...
func (r *Store) Save(key string, value interface{}, immutable bool) (MemEntry, bool) {
	args := *r
	n := len(args)
...
func (r *Store) Set(key string, value interface{}) (MemEntry, bool) {
...
func (r *Store) SetImmutable(key string, value interface{}) (MemEntry, bool) {
	return r.Save(key, value, true)
}

var emptyEntry MemEntry

// GetEntry returns a pointer to the "Entry" found with the given "key"
// if nothing found then it returns an empty MemEntry and false.
func (r *Store) GetEntry(key string) (MemEntry, bool) {
	args := *r
	n := len(args)
	for i := 0; i < n; i++ {
...
// GetEntryAt returns the internal MemEntry of the memStore based on its index,
// the stored index by the router.
// If not found then it returns a zero MemEntry and false.
func (r *Store) GetEntryAt(index int) (MemEntry, bool) {
	args := *r
	if len(args) > index {
...
func (r *Store) GetInt16(key string) (int16, error) {
	v, ok := r.GetEntry(key)
	if !ok {
		return -1, formatError("int16", key)
	}
...
func (r *Store) GetInt32(key string) (int32, error) {
	v, ok := r.GetEntry(key)
	if !ok {
		return -1, formatError("int32", key)
	}
...
func (r *Store) GetInt64(key string) (int64, error) {
	v, ok := r.GetEntry(key)
	if !ok {
		return -1, formatError("int64", key)
	}
...
func (r *Store) GetUint8(key string) (uint8, error) {
	v, ok := r.GetEntry(key)
	if !ok {
		return 0, formatError("uint8", key)
	}
...
func (r *Store) GetUint16(key string) (uint16, error) {
	v, ok := r.GetEntry(key)
	if !ok {
		return 0, formatError("uint16", key)
	}
...
func (r *Store) GetUint32(key string) (uint32, error) {
	v, ok := r.GetEntry(key)
	if !ok {
		return 0, formatError("uint32", key)
	}
...
func (r *Store) GetUint64(key string) (uint64, error) {
	v, ok := r.GetEntry(key)
	if !ok {
		return 0, formatError("uint64", key)
	}
...
func (r *Store) GetFloat64(key string) (float64, error) {
	v, ok := r.GetEntry(key)
	if !ok {
		return -1, formatError("float64", key)
	}
...
func (r *Store) GetBool(key string) (bool, error) {
	v, ok := r.GetEntry(key)
	if !ok {
		return false, formatError("bool", key)
	}
