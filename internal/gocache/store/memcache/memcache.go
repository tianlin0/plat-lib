...
func NewMemcache(client ClientInterface, options ...store.Option) *MemcacheStore {
...
func (s *MemcacheStore) Get(_ context.Context, key any) (any, error) {
	...
	if item == nil {
		return nil, store.NotFoundWithCause(errors.New("unable to retrieve data from memcache"))
	}
...
func (s *MemcacheStore) GetWithTTL(_ context.Context, key any) (any, time.Duration, error) {
	...
	if item == nil {
		return nil, 0, store.NotFoundWithCause(errors.New("unable to retrieve data from memcache"))
	}
...
func (s *MemcacheStore) Set(ctx context.Context, key any, value any, options ...store.Option) error {
...
func (s *MemcacheStore) Invalidate(ctx context.Context, options ...store.InvalidateOption) error {
